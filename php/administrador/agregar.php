...
// Variables que guardan el contenido de los campos del formulario
    if ($_SERVER["REQUEST_METHOD"] == "POST") {
        ...
        if ($ban1 && $ban2 && $ban3 && $ban4 && $ban5 && $ban5 && $ban7 && $ban7 && $ban8 && $ban9) {
          $actualizado = true;
          $query = "INSERT INTO  productos ( nombre ,  descripcion ,  imagen ,  precio ,  disponibles ,  fabricante ,  color ,  capacidad ,  peso )
                      VALUES ('$nombre' ,  '$descripcion' ,  '$imagen' ,  '$precio' ,  '$disponibles' ,  '$fabricante' ,  '$color' ,  '$capacidad' ,  '$peso');";
